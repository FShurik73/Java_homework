package Homework_OOP_5.Core.DB;
...
import Homework_OOP_5.Core.CustomExceptions.BadCsvContentException;
import Homework_OOP_5.Core.CustomExceptions.BadEmailException;
import Homework_OOP_5.Core.Models.Contact;
import Homework_OOP_5.Core.Models.Email;
import Homework_OOP_5.Core.Models.PhoneBook;
import Homework_OOP_5.Core.Models.PhoneNumber;

public class ExternalContactsCSV implements ExternalData{
    private static final String CSV_HEADER = "имена; e-mails; телефоны\n";
    private static final String CSV_DELIMITER = ";";
    private static final String CANNOT_READ_FILE_MSG = "Невозможно прочитать файл, будет использован пустой телефон.";
    private static final String EMPTY_FILE_MSG = "Найден пустой телефонный справочник";
    private static final String BAD_FILE_MSG = "Файл поврежден, некоторые контакты могут быть потеряны";
    private static final String CANNOT_WRITE_FILE_MSG = "Не удается сохранить файл...";
